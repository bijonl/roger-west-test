# General Notes
- To view, drag the index.html file into your browser. 
...
- I would also normally use Gulp (or some compiler) to minify my CSS files and I usually use SCSS. 
...
- There is a basic hover animation on the blue tiles when you hover. 